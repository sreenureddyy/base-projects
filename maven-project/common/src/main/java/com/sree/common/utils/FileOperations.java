...
public class FileOperations {
	public static void copy(String inStr, String outStr) throws Exception {
		PrintLogging.print(4, "Copying file FileIn:" + inStr + ", FileOut:"
				+ outStr);
	...
	public static void copyDirectory(File srcPath, File dstPath)
			throws IOException {
		PrintLogging
				.print(5, "Copying Directory " + srcPath + " to " + dstPath);
	...
	public static void createDirectory(String dir) {
		try {
			...
			if (success) {
				...
				PrintLogging.print(1, "Warning: Failed to create Directory: "
						+ dir);
			}
		} catch (Exception e) {
			PrintLogging.print(1, "Error: creating directory: "
					+ e.getMessage());
		}
	}
	...
	public static void createNestedDirectories(String dir) {
		try {
			...
			if (success) {
				...
				PrintLogging.print(1, "Warning: Failed to create Directories: "
						+ dir);
			}
		} catch (Exception e) {
			PrintLogging.print(1,
					"Error: creating nested directory structure: "
							+ e.getMessage());
		}
	}
	...
	public static void createFile(String filPath, String fileName,
			String contents) {
		try {
			...
			PrintLogging.print(1, "ERROR: Unable to create a write data to "
					+ filPath + "/" + fileName);
		}
	}
}