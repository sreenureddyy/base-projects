...
public class SystemProperties {
		...
		if (SystemType.isWINDOWS()) {
			...
			if (i != -1) {
				...
				PrintLogging.print(1,
						"WARNING: JAVA_HOME may not point to a valid JDK\n");
			}
	...
	public static String xDisplay() {
		...
		if (S == null) {
			PrintLogging
					.print(
							1,
							"WARNING: Guessed the XDisplay to be :0.0 please pass in this parameter using -Ddisplay");
	...
	public static String SystemRoot() {
		...
		if (S == null) {
			PrintLogging
					.print(
							1,
							"WARNING: Guessed the SystemRoot to be C:\\Windows please pass in this parameter using -DSystemRoot");
	...
	public static String userHome() {
		...
		if (S == null) {
			...
			PrintLogging.print(1, "WARNING: Guessed the home directory to be "
					+ S + " please pass in this parameter using -Dhome");
			return S;
		}
