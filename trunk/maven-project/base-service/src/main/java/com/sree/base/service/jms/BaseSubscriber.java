package com.sree.base.service.jms;
	...
	public void onMessage(Message msg) {
		...
		try {
			...
			if (msg instanceof ActiveMQTextMessage) {
				...
				System.out.println("");
				// SmsMessage message = (SmsMessage) ((ObjectMessage)
				// msg).getObject();
				// Way2SmsUtil.sendSMS(message.getUsername(),
				// message.getPassword(), message.getMobile(),
